...
import { savedBlogs } from "../Utils/LocalStorage";
const BlogId = () => {
      ...
      <article className="space-y-8  text-black">
        <div className="space-y-6">
          ...
          <div className="flex items-center -mx-4 overflow-x-auto overflow-y-hidden sm:justify-start flex-nowrap text-gray-100">
            ...
            <div onClick={()=>handleBookMark(blog)} className="bg-primary bg-opacity-20 hover:bg-opacity-30 text-secondary ml-3 overflow-hidden cursor-pointer p-3 text-2xl rounded-full">
          <MdBookmarkAdd />
          </div>
          </div>
